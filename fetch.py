...
EMBEDDING_MODEL = "models/my_classifier2.pkl"
TENSOR_NAME = "Meta"  # Label Faces in the Wild
CONFIG_PATH = os.path.join(BASE_DIR, "oss_demo_projector_config.json")
TENSOR_PATH = os.path.join(BASE_DIR, "tensor.bytes")
LABELS_PATH = os.path.join(BASE_DIR, "Meta_label.tsv")
IMAGE_SPRITES_PATH = os.path.join(BASE_DIR, "spritesTest.png")
IMAGE_SIZE = 28
